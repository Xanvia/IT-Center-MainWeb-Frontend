    ...
    <div className="relative">
      ...
      >
        ...
        <Image
          ...
          height={112}
          src={
            getAbsoluteImageUrl(session?.user.image) || "/users/generalUser.png"
          }
          alt="User"
        ...
        <ul className="flex flex-col gap-5 border-b px-6 py-7">
          {!reservation && (
            <li
              ...
              className="flex items-center gap-3.5 duration-300 ease-in-out hover:text-gray-500 lg:text-base cursor-pointer"
            >
              <svg
          ...
          <li
            ...
            className="flex items-center gap-3.5 duration-300 ease-in-out hover:text-gray-500 cursor-pointer lg:text-base"
          >
            <svg
              className="fill-current"
              width="22"
